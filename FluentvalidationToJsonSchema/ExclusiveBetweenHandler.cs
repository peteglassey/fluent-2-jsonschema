...
{
    public class ExclusiveBetweenHandler : IFluentValidatorSchemaHandler
    {
        public bool CanHandle(object validator) => validator.GetType().Name.Contains(typeof(FluentValidation.Validators.ExclusiveBetweenValidator<,>).Name);
        ...
        public void Apply(object validator, PropertyInfo propertyInfo, JsonSchemaProperty propertySchema)
        {
            ...
            if (fromValue != null && toValue != null)
            {
                if (propertyInfo.PropertyType == typeof(int) || propertyInfo.PropertyType == typeof(long) || propertyInfo.PropertyType == typeof(short))
                {
                    ...
                    {
                        var min = System.Convert.ToInt64(fromValue) + 1;
                        var max = System.Convert.ToInt64(toValue) - 1;
